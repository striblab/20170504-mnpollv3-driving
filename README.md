# Star Tribune - Minnesota Poll 2017: Distracted Driving
...
1. Get code and enter project: `git clone https://github.com/striblab/20170504-mnpollv3-driving.git && cd 20170504-mnpollv3-driving.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170504-mnpollv3-driving/ && rsync -rav ./ ../20170504-mnpollv3-driving/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
